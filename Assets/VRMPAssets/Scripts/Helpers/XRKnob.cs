...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    public class XRKnob : UnityEngine.XR.Interaction.Toolkit.Interactables.XRBaseInteractable
    {
        ...
        public float value
        {
            ...
            {
                SetValue(value);
                SetKnobRotation(ValueToRotation(), allowX, allowY, allowZ);
            }
        }
        ...
        void UpdateRotation(bool freshCheck = false)
        {
            ...
            SetKnobRotation(knobRotation, allowX, allowY, allowZ);
        ...
        void SetKnobRotation(float angle, bool allowX, bool allowY, bool allowZ)
        {
